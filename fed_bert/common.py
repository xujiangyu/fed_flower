...
#                 f"--max-update {TOTAL_UPDATES} --log-format simple --log-interval 1 --tensorboard-logdir {ROOT_DIR}/client_{CLIENT_ID}/logdir --save-interval 1 --max-epoch {current_iter}" \
#                 f"--save-dir {ROOT_DIR}/client_{CLIENT_ID}/checkpoints --restore-file {ROOT_DIR}/client_{CLIENT_ID}/server/checkpoint_avg_{epoch}.pt"
