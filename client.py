    ...
    for _ in range(0, epochs):
        ...
        for images, labels in tqdm(trainloader):
            ...
            if y_score is None:
                ...
                y_score = np.vstack([y_score, outputs.cpu().detach().numpy().reshape(outputs.shape)])
        ...
        print("epoch {}/{},   training loss: {},   training accuracy: {}".format(str(_ + 1), str(epochs), running_loss_,
                                                                                 accuracy))
        log.logger.info(
            "epoch: {}/{},   training loss: {},   training accuracy: {}".format(str(_ + 1), str(epochs), running_loss_,
                                                                                 accuracy))
...
class FlowerClient(fl.client.NumPyClient):
    ...
    def fit(self, parameters, config):
        ...
        return self.get_parameters(config={}), len(trainloader.dataset), {"loss=" + str(float(auc)) + "_" + "accuracy": accuracy}
